...
さらに重要なアプローチとして、「引き返せない決断」を複数の「やり直しがきく決断」に分割することも可能です。これはウォーターフォール開発とアジャイル開発の関係に似ています。例えば、100枚のチケットを一度に販売するという引き返せない決断を、20枚ずつ5回に分けて販売するという複数のやり直しがきく決断に変換できます。最初の20枚の販売結果を見て、販売方法や告知のタイミングを調整し、次の20枚に反映させることができます。価格変更が必要な場合は、別の価格帯のチケット枠を新たに設けるという形で対応します。
