...
- Namespace そのものではないけど、主催メンバーが Slack と Jira と Zoom と connpass それぞれでいろいろな名前を使っているのは、座長から見るとつらい状況でした。PyCon JP Slack には「名前 ++ 」でほめるという文化があるのですが、アカウントが把握しづらいこともあり、私は積極的な活用を控えました。
